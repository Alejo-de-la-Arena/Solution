...
/**
 * Acceso privado: solo para administrador y mayoristas aprobados.
 * No hay enlace en la Navbar; se usa cuando un guard redirige (ej. /admin o /mayorista sin sesión).
 */
  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <h1 className="text-3xl sm:text-4xl font-heading tracking-wider text-center mb-2">Acceso</h1>
        <p className="text-white/60 text-center text-sm mb-10">
          Solo para administrador y mayoristas aprobados. Si fuiste aceptado, usá el email y contraseña que te enviamos.
        </p>
