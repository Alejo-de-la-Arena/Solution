...
function SocialIcon({ href, label, children }) {
  return (
    <a
      ...
      onMouseLeave={(e) => { e.currentTarget.style.color = 'var(--sol-muted)'; e.currentTarget.style.borderColor = 'var(--sol-line-mid)'; }}
    >
      {children}
    </a>
  );
      ...
      >
        ...
        >
          ...
          <div>
            <div
              className="font-jmono"
              style={{ fontSize: 12, letterSpacing: '0.28em', textTransform: 'uppercase', color: 'var(--sol-ink)', marginBottom: 16 }}
            >
              SOLUTION
            </div>
            <p
              className="font-jakarta"
              style={{ fontSize: 13, lineHeight: 1.65, color: 'var(--sol-ink-dim)', maxWidth: 220 }}
            >
          ...
          <div>
            <div
              className="font-jmono"
              style={{ fontSize: 9, letterSpacing: '0.22em', textTransform: 'uppercase', color: 'var(--sol-muted)', marginBottom: 18 }}
            >
              Navegación
            </div>
            <div>
          ...
          <div>
            ...
            <FooterAnchor href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</FooterAnchor>
            <FooterAnchor href={`https://wa.me/${WHATSAPP_NUMBER}`}>WhatsApp</FooterAnchor>

            {/* Social icons */}
            <div style={{ display: 'flex', gap: 8, marginTop: 20 }}>
              <SocialIcon href={INSTAGRAM_URL} label="Instagram">
                {/* Instagram */}
                <svg style={{ width: 15, height: 15 }} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
        ...
        >
          <p
            className="font-jmono"
            style={{ fontSize: 9, letterSpacing: '0.18em', textTransform: 'uppercase', color: 'var(--sol-muted)' }}
          >
            © 2026 SOLUTION — Todos los derechos reservados.
          </p>
          <p
            className="font-jmono sol-arg"
            style={{ fontSize: 9, letterSpacing: '0.18em', textTransform: 'uppercase', color: 'var(--sol-muted)', display: 'flex', alignItems: 'center' }}
          >
            Hecho en Argentina
          </p>
        </div>
