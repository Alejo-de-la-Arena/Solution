  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex max-w-4xl flex-col items-center text-center">
        <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-semibold tracking-wider mb-5 md:mb-6">
          Programa Mayorista
        </h1>
        <p className="text-lg md:text-xl text-white/80 max-w-2xl mx-auto leading-relaxed mb-8 md:mb-9">
        ...
        <motion.button
          ...
          className="scroll-indicator mt-8 md:mt-9 flex flex-col items-center gap-1.5 text-white/60 hover:text-white/90 transition-colors cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:ring-offset-2 focus-visible:ring-offset-black rounded"
